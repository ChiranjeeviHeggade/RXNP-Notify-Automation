...
/*
@ClassName- GetResponseUtilForRefillReminder7daysEmail
@usage- The class contains API methods which required to generate emails
@Author-Basagouda Patil
*/
public class GetResponseUtilForRefillReminder7daysEmail {
...
*/
    public static String setEmailAPIBody() throws IOException {
        ...
        String plus7days = Date.sevendays();
        content = content.replace("$WCRDATE",plus7days);
        return content;
