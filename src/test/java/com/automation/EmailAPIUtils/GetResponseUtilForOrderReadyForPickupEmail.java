...
/*
@ClassName- GetResponseUtilForOrderReadyForPickupEmail
@usage- The class contains API methods which required to generate emails
@Author-Basagouda Patil
*/
public class GetResponseUtilForOrderReadyForPickupEmail {
...
*/
    public static String setEmailAPIBody() throws IOException {
        ...
        File xmlfile = new File("src/test/java/Payloads/OrderReadyForPickup.xml");
        ...
        String Current_Day = Date.todayDate();
        content = content.replace("$WCRDATE",Current_Day);
        return content;
    }
