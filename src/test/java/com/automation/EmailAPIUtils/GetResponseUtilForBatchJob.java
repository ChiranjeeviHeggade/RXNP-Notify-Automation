...
*/
public class GetResponseUtilForBatchJob {

    private String setBaseUrl()
    {
        return GlobalVar.data.get("BASE_URL_BatchJob");
    }
...
*/
    public static String setEmailMailAPIBody()
    {
...
//        return body.toString();
    ...
    */
    public HttpResponse getAPIResponse() throws InterruptedException {
        ...
        Thread.sleep(5000);
        request.setStringBody(setEmailMailAPIBody());
