...
*/
    public static String setEmailAPIBody()
    {
        ...
        rxDetails.put("drugName","");

                date_selection s = new date_selection();
                String Expirydate = s.date();
                System.out.println("_______________________" + Expirydate + "______________________");
                rxDetails.put("prescriptionExpiryDate", Expirydate);
