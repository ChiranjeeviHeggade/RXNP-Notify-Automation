...
*/
public class GetResponseUtilForTransferRequestEmail {
...
*/
    public static String setMarketingMailAPIBody()
    {
        ...
        rxDetails.put("rxId", GlobalVar.data.get("PRESCRIPTION_NUMBER"));
                ...
                String refilldate = s.date();
                //System.out.println("_______________________" + refilldate + "______________________");
        rxDetails.put("refillDate", refilldate);
