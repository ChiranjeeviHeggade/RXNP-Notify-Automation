...
/*
@ClassName- GetResponseUtilForReturnToStockWarningEmail
@usage- The class contains API methods which required to generate emails
@Author-Basagouda Patil
*/
public class GetResponseUtilForReturnToStockWarningEmail {
...
*/
    public static String setEmailAPIBody() throws IOException {
        ...
        File xmlfile = new File("src/test/java/Payloads/PickupReminder.xml");
        ...
        String Past_Day = Date.elevendays();
