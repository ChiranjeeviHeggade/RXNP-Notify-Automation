...
public class GetCartItemsResponse {
    ...
    private WysiwygOrderSummary wysiwygOrderSummary;
    ...
    public WysiwygOrderSummary getWysiwygOrderSummary() {
        return wysiwygOrderSummary;
    }

    public void setWysiwygOrderSummary(WysiwygOrderSummary wysiwygOrderSummary) {
