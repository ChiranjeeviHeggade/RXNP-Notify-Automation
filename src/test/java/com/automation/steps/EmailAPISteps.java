...
public class EmailAPISteps {
    AppiumDriver driver = AppiumDriverManager.getDriver();
    Pharmacy_EmailAPIMethods pharmacyEmailMethods = new Pharmacy_EmailAPIMethods(driver);
...
//    }
    ...
    public  void userVerifyTheLinksPresentInEmailBody() throws MalformedURLException, InterruptedException, FileNotFoundException, UnsupportedEncodingException {
...
////    }
    ...
    public void userPOSTSAPIRequestForBatchJob() throws InterruptedException {
        pharmacyEmailMethods.sendAndVerifyAPIRequestForBatchJob();
    }
