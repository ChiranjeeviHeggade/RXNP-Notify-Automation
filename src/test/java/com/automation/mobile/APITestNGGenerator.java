...
@Usage-This class helps to generate TestNG XML for API Test execution
 */

public class APITestNGGenerator {
    TestNG newTestNG = new TestNG();

    public APITestNGGenerator(String testType, int threadCount) throws Exception {
    ...
    private void createParallelXml(int threadCount) {
        ...
        testSuite.setName("APIAutomation");
    ...
    private static List<XmlPackage> getPackages() {
        ...
        eachPackage.setName("com.automation.mobile.distribute");
