...
public class AppiumDevice {
    ...
    private JSONObject bitriseData = new JSONObject();
    ...
    public boolean hasConfigureData(String configureName) {
        return appiumDeviceData.containsKey("configureName");
    }
    ...
    public String getMailSecretKEY() {
        return appiumDeviceData.get(BannerConfType.SECRETKEY);
    }
    ...
    public String getZipCode(String zipType) {
        switch (zipType) {
            ...
            case "pickupzipcode":
                return appiumDeviceData.get(BannerConfType.PICKUP_ZIPCODE);
        }
    ...
    public JSONObject getBitriseData() {
        return bitriseData;
    }

    public void setBitriseData(JSONObject bitriseData) {
        this.bitriseData = bitriseData;
    }

    public int getWdaLocalPort() {
        return Integer.valueOf(appiumDeviceData.get(MobileConfType.WDA_LOCAL_PORT));
    }
}
