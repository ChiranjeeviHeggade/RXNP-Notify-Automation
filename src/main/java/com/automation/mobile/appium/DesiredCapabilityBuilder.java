...
public class DesiredCapabilityBuilder {
    ...
    public static String getAppPath(AppiumDevice appiumDevice) throws IOException {
...
//            }
    ...
    public static String getAppName(AppiumDevice appiumDevice) {
...
//            }
    ...
    public static void buildDesiredCapability(AppiumDevice appiumDevice) throws IOException {
        ...
        String appPath = ad.hasConfigureData("app_path") && !ad.getConfigureData("app_path").isEmpty() ? ad.getConfigureData("app_path") : getAppPath(ad);
        String appName = ad.hasConfigureData("app_name") && !ad.getConfigureData("app_name").isEmpty() ? ad.getConfigureData("app_name") : getAppName(ad);
...
//            dc.setCapability(MobileCapabilityType.FULL_RESET, true);
            ...
            dc.setCapability(MobileCapabilityType.FULL_RESET, false);
            dc.setCapability(MobileCapabilityType.NO_RESET, true);
            dc.setCapability("acceptSslCert", true);
            dc.setCapability("locationServicesEnabled", true);
            dc.setCapability("locationServicesAuthorized", false);
            dc.setCapability("automationName", ad.getConfigureData(MobileCapabilityType.AUTOMATION_NAME));
            dc.setCapability("platformName", ad.getConfigureData(MobileCapabilityType.PLATFORM_NAME));
            dc.setCapability("deviceName", ad.getConfigureData(MobileCapabilityType.DEVICE_NAME));
            dc.setCapability("platformVersion", ad.getConfigureData(MobileCapabilityType.PLATFORM_VERSION));
            dc.setCapability("bundleId", ad.getConfigureData(BannerConfType.BUNDLE_ID));
