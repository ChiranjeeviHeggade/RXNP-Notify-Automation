...
public class AhemEmailService {
    ...
    public static HttpResponse getEmailContent(String mailBoxName) {

        HttpRequest request = new HttpRequest();

        String url = AhemMailConstants.URL + AhemMailConstants.AUTH + AhemMailConstants.MAIL + mailBoxName;
